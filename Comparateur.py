import EvaluateurBreakDown as bd
import EvaluateurIBreakDown as ibd
import EvaluateurLIME as lime
import EvaluateurSHAP as shap
import numpy as np
...
def comparateur(data, y, feature_names, modele):
    ...
    for i in range (1,n_f):
        ...
        mauvaises_pred_lime = mauvaises_pred_lime + lime.eval_lime(data, y, feature_names, i, modele)
        mauvaises_pred_shap = mauvaises_pred_shap + shap.eval_shap(data, y, feature_names, i, modele)
